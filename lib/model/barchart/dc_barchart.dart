...
class DC_BarChart extends StatelessWidget {
  Future<List<MonthData>> fetchDataFromApi() async {
    final response = await http.get(Uri.parse('http://103.150.48.70:6116/GAZI/management_dashboard/dc_barchart.php'));
  ...
  //         children: [
  //
  //           Text("Delivery Challan of last 6 Month",
  //             style: TextStyle(
  //                 color: Colors.blue,
  //                 fontWeight: FontWeight.bold,
  //                 fontSize: 25
...
class MonthData {
  ...
  factory MonthData.fromJson(Map<String, dynamic> json) {
    ...
    final double value = double.parse(json['DC']);
    return MonthData(
      month: month,
      business: business,
      value: value,
