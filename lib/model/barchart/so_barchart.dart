...
class SO_BarChart extends StatelessWidget {
  Future<List<MonthData>> fetchDataFromApi() async {
    final response = await http.get(Uri.parse('http://103.150.48.70:6116/GAZI/management_dashboard/so_barchart.php'));
  ...
  //         children: [
  //
  //           Text("Sales Order of last 6 Month",
  //             style: TextStyle(
  //                 color: Colors.blue,
  //                 fontWeight: FontWeight.bold,
  //                 fontSize: 25
...
class MonthData {
  ...
  factory MonthData.fromJson(Map<String, dynamic> json) {
    ...
    final double value = double.parse(json['SO']);
    return MonthData(
      month: month,
      business: business,
      value: value,
